...
export const levels: GameLevel[] = [
  ...
  },
  {
    ...
    requiredActions: ['open_eventviewer', 'view_system_log', 'run_driverquery', 'rollback_driver', 'open_printer'],
    hints: [
  ...
  },
  {
    ...
    requiredActions: ['open_taskmanager', 'kill_malware_process', 'view_system_log', 'run_antivirus_scan', 'remove_threats', 'open_cloudbackup', 'restore_backup'],
    hints: [
      ...
      'Otvorite Preglednik događaja i provjerite sistemski dnevnik za tragove napada.',
